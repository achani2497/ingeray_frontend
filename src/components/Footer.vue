...
.facebook-icon{
  background-image: url('../assets/images/icons/footerIcons/facebook.svg');
}
.instagram-icon{
  background-image: url('../assets/images/icons/footerIcons/instagram.svg');
}
.youtube-icon{
  background-image: url('../assets/images/icons/footerIcons/youtube.svg');
}
.ingeray-icon{
